...
`,aa=()=>{const t=localStorage.getItem("users");$d();const e=fr(s=>s.cart.items.length),n=()=>{localStorage.clear("users"),gt.success("Logout Successfult"),console.log("logout",t)},r=()=>{document.getElementById("menuopen").style.display="flex",document.getElementById("menuopen").style.width="100%"},i=()=>{document.getElementById("menuopen").style.display="none",document.getElementById("menuopen").style.width="0"};return p.jsx(p.Fragment,{children:p.jsxs(s6,{children:[p.jsx("div",{children:p.jsx(i6,{src:bg,alt:"SiteLogo"})}),p.jsx("div",{children:p.jsxs("ul",{id:"menuopen",children:[p.jsx(ht,{to:"/Home",children:"Home"}),p.jsx(ht,{to:"/shop",children:"Shop"}),p.jsx(ht,{to:"/about",children:"About"}),t?p.jsx(ht,{onClick:n,children:"LogOut"}):p.jsx(ht,{to:"/Login",children:"Login"}),p.jsx(r6,{size:"1.9rem",color:"black",id:"cross",onClick:i})]})}),p.jsxs("div",{children:[p.jsxs("div",{children:[p.jsx(ht,{to:"/Cart",children:p.jsx(U3,{size:"1.7rem",color:"#383838"})}),e>=0&&p.jsx("span",{className:"badge badge-danger",children:e})]}),t?p.jsx(ht,{onClick:n,id:"logout",children:"LogOut"}):p.jsx(ht,{to:"/Login",children:"Login"}),p.jsx(o6,{children:p.jsx($3,{size:"1.7rem",onClick:r})})]})]})})};var Ov={};/**
 * @license
